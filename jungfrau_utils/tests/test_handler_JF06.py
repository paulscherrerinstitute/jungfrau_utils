...
DETECTOR_NAME = "JF06T04V01"
DATA_SHAPE = (4 * 512, 1024)
STACK_SHAPE = (5, *DATA_SHAPE)
DATA_SHAPE_WITH_GAPS = (4 * (512 + 2), 1024 + 6)

# swapped values, because JF06 detectors are rotated 90 deg in case of geometry=Trues
DATA_SHAPE_WITH_GEOMETRY = (1106 + 1024, 618 + 512)
DATA_SHAPE_WITH_GAPS_WITH_GEOMETRY = (1106 + 1024 + 6, 618 + 512 + 2)
...
@pytest.mark.skip(reason="get_shape_out returns not a flipped shape for JF06 detectors")
