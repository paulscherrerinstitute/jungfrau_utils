...
def reverse_pixel_mask(
    ...
    """Get raw pixel mask from converted mask.

    Args:
        detector_name (str): Name of the detector.
        mask (ndarray): Pixel mask to convert.
        gap_pixels (bool, optional): Whether converted mask has gap_pixels applied. Defaults to True.
        geometry (bool, optional): Whether converted mask has geometry applied. Defaults to True.
